  ...
  return (
    <div className="flex flex-col h-screen bg-[#020617] text-white font-sans overflow-hidden selection:bg-cyan-500 selection:text-black">
      ...
      <header className="h-32 flex flex-col items-center justify-center relative z-20 mt-20">
        <div className="w-20 h-20 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-3xl flex items-center justify-center shadow-[0_0_50px_rgba(6,182,212,0.3)] mb-6 transform hover:scale-105 transition-transform duration-500">
          <Droplets className="text-white" size={40} />
        </div>
        <h1 className="font-black text-5xl md:text-6xl tracking-tighter leading-none text-white drop-shadow-2xl text-center">LAVADERO VIP</h1>
        <span className="text-sm text-cyan-400 font-bold uppercase tracking-[0.4em] mt-2 text-center">Elite Car Wash</span>
      </header>
      ...
      <main className="flex-1 flex items-center justify-center relative z-10 px-4 mt-8">
        <div className="max-w-md w-full">
          ...
          <Link href="/login" className="group relative bg-slate-900/40 backdrop-blur-xl border border-white/5 p-10 rounded-[3rem] transition-all duration-500 hover:bg-slate-800/60 hover:border-cyan-500/30 hover:shadow-[0_0_50px_rgba(6,182,212,0.15)] overflow-hidden flex flex-col justify-between h-80">
            ...
            <div className="relative z-10">
              <div className="w-16 h-16 bg-white/5 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-cyan-500 group-hover:text-black transition-colors duration-500">
                <LogIn size={28} />
              </div>
            ...
            <div className="relative z-10 flex items-center gap-2 text-cyan-400 font-bold tracking-widest uppercase text-xs">
